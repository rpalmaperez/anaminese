-- Initial schema migration for Anamnese App
...
-- Create function for anamnese versioning
...
-- Create function to expire old anamneses
...
BEGIN
    -- Notify about anamneses expiring in 30 days
    ...
    -- Mark expired anamneses and notify
                    ...
                    CASE action->>'type'
                        WHEN 'create' THEN
                            INSERT INTO anamneses (
                                ...
                                COALESCE((action->'data'->>'id')::UUID, gen_random_uuid()),
